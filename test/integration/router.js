...
describe('routing tests', function() {
  ...
  it('the page selector switches pages', async function() {
    ...
    await testNavigation(page, 'products', 'Products');
    await testNavigation(page, 'products', 'contacts');
  ...
  it('the page selector switches pages in a different way', async function() {
    ...
    await testNavigationInADifferentWay(page, 'products', 'Products');
    await testNavigationInADifferentWay(page, 'products', 'contacts');
